from tools import hex32_to_ascii

from encrypt import encrypt
from decrypt import decrypt
from square import square4_test
...
class TestDecrypt(unittest.TestCase):
    ...
    def test_str_message(self):
        self.assertEqual(hex32_to_ascii(int(decrypt(0xc69f25d0025a9ef32393f63e2f05b747, 0x2b7e151628aed2a6abf7158809cf4f3c), 16)), "theblockbreakers")
...
class TestSquare(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(square4_test(masterKey), "2b7e151628aed2a6abf7158809cf4f3c")

    def test_2(self):
        masterKey = 0x000102030405060708090a0b0c0d0e0f

        self.assertEqual(square4_test(masterKey), "102030405060708090a0b0c0d0e0f")

    def test_3(self):
        masterKey = 0x763979244226452948404D635166546A

        self.assertEqual(square4_test(masterKey), "763979244226452948404d635166546a")

    def test_4(self):
        masterKey = random.randint(0, 2^128)
        self.assertEqual(square4_test(masterKey), hex(masterKey)[2:])
